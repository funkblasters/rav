...
export function FlagsPage() {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-start justify-between gap-4 flex-col sm:flex-row !mb-0 sm:mb-0">
        <div>
      ...
      {/* Sticky bar: search + toggle (toggle visible on mobile only) */}
      <div className="sticky -top-10 z-10 bg-background -mx-4 px-4 !mt-0 pt-6 pb-3 sm:static sm:bg-transparent sm:mx-0 sm:px-0 sm:!mt-6 sm:pt-0 sm:pb-0">
